...
exports.uploadPdf = async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      fileName: req.file.originalname,
      filePath: req.file.filename, // Send the actual filename generated by multer
      extractedTextContent: project.extractedTextContent // Send full content back for frontend state sync
    });
  } catch (error) {
